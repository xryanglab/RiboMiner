...
LastEditTime: 2020-12-27 12:08:23
...
def create_parse_for_trans_coverage():
	...
	parser.add_option("-m","--mode",action="store",type="string",dest="mode",default='single-gene',
			help="Mode for input. Either 'single-gene' or 'gene-list'. default=%default.")
...
def parse_for_trans_coverage():
	...
	(InputFile,output_prefix,coorFile,mode,targetGene,id_type,color,ymin,ymax)=(options.InputFile,options.output_prefix,options.coorFile,options.mode,
