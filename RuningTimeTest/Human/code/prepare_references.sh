...
workdir=.
genome_fasta=../data/Ref/Homo_sapiens.GRCh38.dna.primary_assembly.fa
gtf=../data/Ref/Homo_sapiens.GRCh38.88.gtf
...
OutputTranscriptInfo -c ../results/Ref/RiboCode_annot/transcripts_cds.txt -g ../results/Ref/Homo_sapiens.GRCh38.88.gtf -f ../results/Ref/RiboCode_annot/transcripts_sequence.fa -o ../results/Ref/longest.transcripts.info.txt -O ../results/Ref/all.transcripts.info.txt
