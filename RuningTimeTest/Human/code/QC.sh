...
i=SRR2873530
StatisticReadsOnDNAsContam -i ../../data/00.STAR/${i}_STAR/${i}.Aligned.sortedByCoord.out.bam -g ../../results/Ref/Homo_sapiens.GRCh38.88.gtf -o test_${i}
cd ../../code
echo "RPF statistics finished!"

## RiboDensityOfDiffFrames
mkdir -p $results/RiboDensityFromDiffFrames
RiboDensityOfDiffFrames -f ../data/attributes_P.txt -c ../results/Ref/longest.transcripts.info.txt -o $results/RiboDensityFromDiffFrames/test --plot yes
