...
all_mean_density_non_zeros['Ctrl'] <- all_mean_density_non_zeros$`Ctrl-2`
all_mean_density_non_zeros['Severe-HS-2hrs'] <- all_mean_density_non_zeros$`Severe-HS-2hrs-2`
#all_mean_density_non_zeros['ASNase'] <- (all_mean_density_non_zeros$`ASNase-1`+all_mean_density_non_zeros$`ASNase-2`)/2
all_mean_density_non_zeros['FC(Severe-HS-2hrs/Ctrl)'] <- all_mean_density_non_zeros$`Severe-HS-2hrs`/all_mean_density_non_zeros$Ctrl
colnames(all_mean_density_non_zeros)[1] <- "trans_id"

FC_le_0.67 <- all_mean_density_non_zeros[all_mean_density_non_zeros$`FC(Severe-HS-2hrs/Ctrl)`<=0.5,]
FC_ge_1.5 <- all_mean_density_non_zeros[all_mean_density_non_zeros$`FC(Severe-HS-2hrs/Ctrl)`>=2,]
FC_lt1.5_gt0.67 <- all_mean_density_non_zeros[all_mean_density_non_zeros$`FC(Severe-HS-2hrs/Ctrl)`<2&all_mean_density_non_zeros$`FC(Severe-HS-2hrs/Ctrl)`>0.5,]
