...
EnrichmentAnalysis --ctrl $results/EnrichmentAnalysis/test_Ctrl-2_cds_codon_density.txt --treat $results/EnrichmentAnalysis/test_Severe-HS-2hrs-2_cds_codon_density.txt -c ../results/Ref/longest.transcripts.info.txt -o $results/EnrichmentAnalysis/test -U codon -M RPKM -l 150 -n 10 -m 1 -e 30 --CI 0.95 -u 0 -d 500
