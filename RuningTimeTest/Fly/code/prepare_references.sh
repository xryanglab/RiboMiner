...
workdir=.
genome_fasta=../data/Ref/Drosophila_melanogaster.BDGP6.22.dna.toplevel.fa
gtf=../data/Ref/Drosophila_melanogaster.BDGP6.22.98.gtf
...
OutputTranscriptInfo -c ../results/Ref/RiboCode_annot/transcripts_cds.txt -g ../results/Ref/Drosophila_melanogaster.BDGP6.22.98.gtf -f ../results/Ref/RiboCode_annot/transcripts_sequence.fa -o ../results/Ref/longest.transcripts.info.txt -O ../results/Ref/all.transcripts.info.txt
